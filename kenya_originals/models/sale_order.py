...
class SaleReport(models.Model):
    ...
    division_id = fields.Many2one('division.name', string="Division", readonly=True)
    region_id = fields.Many2one('region.name', string="Region", readonly=True)
    area_id = fields.Many2one('region.areas', string="Area", readonly=True)
